            ...
            $(params)._Ajax({
                    ...
                    success: function (result) {
                            if (result.code==0) {
                              ...
                              sessionStorage.setItem("registerTime", result.user.registerTime);
                              if(result.user.lawyerId != null){
                              sessionStorage.setItem("userTpyeZH","律师");
                                } 
                            if(result.user.officeId != null){
                                sessionStorage.setItem("userTpyeZH","律所");  
                            }   
                            if(result.user.officeId == null & result.user.lawyerId == null){
                                sessionStorage.setItem("userTpyeZH","用户");  
                            }
                            if(urlparam == "legalLoan"){
